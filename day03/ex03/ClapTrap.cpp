...
/*   Updated: 2022/06/30 18:12:18 by obeaj            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
    this->name = name;
    std::cout << this->name << " : Oh here I am, just get created, thanks god! "<< std::endl;
}

ClapTrap::~ClapTrap()
{
    std::cout << this->name << " : Oh now i'm dying! bye ." << std::endl;
}
